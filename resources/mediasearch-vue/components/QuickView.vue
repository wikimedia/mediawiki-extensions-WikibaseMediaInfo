<template>
	...
	>
		...
		<div class="wbmi-quick-view__body">
			<h3 v-if="displayName" class="wbmi-quick-view__title">
				<a ref="title"
					:href="canonicalurl"
					:title="title"
					target="blank">
			...
			<p v-if="displayName" class="wbmi-quick-view__list-item">
			...
			<p v-if="displayNameWithoutExtension" class="wbmi-quick-view__list-item">
