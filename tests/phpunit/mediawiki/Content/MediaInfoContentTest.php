...
class MediaInfoContentTest extends PHPUnit_Framework_TestCase {
	...
	/**
	 * @dataProvider provideStubs
	 */
	public function testIsStub( MediaInfo $mediaInfo ) {
		$mediaInfoContent = new MediaInfoContent( new EntityInstanceHolder( $mediaInfo ) );

		$this->assertTrue( $mediaInfoContent->isStub() );
	}

	public function provideNotStubs() {
		$notStubs = [
			[ new MediaInfo() ],
	...
	/**
	 * @dataProvider provideNotStubs
	 */
	public function testIsNotStub( MediaInfo $mediaInfo ) {
		$mediaInfoContent = new MediaInfoContent( new EntityInstanceHolder( $mediaInfo ) );

		$this->assertFalse( $mediaInfoContent->isStub() );
	}
